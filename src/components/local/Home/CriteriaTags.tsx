...
function CriteriaTags() {
  return (
    <div className='w-full flex justify-around'>
      <div className='border rounded-md flex items-center w-1/5 h-32 space-x-2 p-2 shadow-md hover:scale-110 hover:-translate-y-3 transform scale-100 transition duration-200'>
